...
const offset = (options, deps) => {
  const result = core.offset(options);
  return {
    name: result.name,
    fn: result.fn,
...
const shift = (options, deps) => {
  const result = core.shift(options);
  return {
    name: result.name,
    fn: result.fn,
    options: [options, deps]
...
const limitShift = (options, deps) => {
  const result = core.limitShift(options);
  return {
    fn: result.fn,
    options: [options, deps]
  };
...
const flip = (options, deps) => {
  const result = core.flip(options);
  return {
    name: result.name,
    fn: result.fn,
    options: [options, deps]
...
const size = (options, deps) => {
  const result = core.size(options);
  return {
    name: result.name,
    fn: result.fn,
    options: [options, deps]
...
const autoPlacement = (options, deps) => {
  const result = core.autoPlacement(options);
  return {
    name: result.name,
    fn: result.fn,
    options: [options, deps]
...
const hide = (options, deps) => {
  const result = core.hide(options);
  return {
    name: result.name,
    fn: result.fn,
    options: [options, deps]
...
const inline = (options, deps) => {
  const result = core.inline(options);
  return {
    name: result.name,
    fn: result.fn,
    options: [options, deps]
