...
const PopperAnchor = import_stacks.YStack.extractable(
  React.forwardRef(
    function(props, forwardedRef) {
      ...
      const stackProps = anchorProps, safeSetReference = React.useCallback(
        (node) => {
        ...
        [refs.setReference]
      ), refProps = getReferenceProps ? getReferenceProps(stackProps) : null, shouldHandleInHover = import_constants.isWeb && scope, composedRefs = (0, import_compose_refs.useComposedRefs)(
        forwardedRef,
        ref,
  ...
  function(props, forwardedRef) {
    const { scope, enableAnimationForPositionChange, children, passThrough, ...rest } = props, context = usePopperContext(scope), { strategy, placement, refs, x, y, getFloatingProps, size, isPositioned } = context, safeSetFloating = React.useCallback(
      (node) => {
        (0, import_start_transition.startTransition)(() => {
      ...
      [refs.setFloating]
    ), contentRefs = (0, import_compose_refs.useComposedRefs)(safeSetFloating, forwardedRef), [needsMeasure, setNeedsMeasure] = React.useState(
