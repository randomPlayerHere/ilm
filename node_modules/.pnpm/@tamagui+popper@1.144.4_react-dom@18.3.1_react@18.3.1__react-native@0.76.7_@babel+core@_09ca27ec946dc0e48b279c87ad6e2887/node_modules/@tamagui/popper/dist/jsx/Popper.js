...
const PopperAnchor = YStack.extractable(
  React.forwardRef(
    function(props, forwardedRef) {
      ...
      const stackProps = anchorProps, safeSetReference = React.useCallback(
        ...
        [refs.setReference]
      ), refProps = getReferenceProps ? getReferenceProps(stackProps) : null, shouldHandleInHover = isWeb && scope, composedRefs = useComposedRefs(
        forwardedRef,
        ref,
  ...
  function(props, forwardedRef) {
    const { scope, enableAnimationForPositionChange, children, passThrough, ...rest } = props, context = usePopperContext(scope), { strategy, placement, refs, x, y, getFloatingProps, size, isPositioned } = context, safeSetFloating = React.useCallback(
      ...
      [refs.setFloating]
    ), contentRefs = useComposedRefs(safeSetFloating, forwardedRef), [needsMeasure, setNeedsMeasure] = React.useState(
