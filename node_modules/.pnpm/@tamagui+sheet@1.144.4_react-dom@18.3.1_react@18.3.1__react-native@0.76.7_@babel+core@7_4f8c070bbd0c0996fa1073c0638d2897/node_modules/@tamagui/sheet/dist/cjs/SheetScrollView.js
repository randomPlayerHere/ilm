...
const SHEET_SCROLL_VIEW_NAME = "SheetScrollView", SheetScrollView = import_react.default.forwardRef(
  ({
    ...
    return (0, import_react.useEffect)(() => {
    ...
    }, [hasScrollableContent]), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      import_scroll_view.ScrollView,
      {
        ...
        onStartShouldSetResponder: () => (scrollBridge.scrollStartY = -1, state.current.isDraggingScrollArea = !0, !1),
        onMoveShouldSetResponder: (e) => {
          if (!scrollable) return !1;
          const { pageY } = e.nativeEvent;
          return state.current.lastPageY === 0 ? (state.current.lastPageY = pageY, !1) : Math.abs(pageY - state.current.lastPageY) > 10;
        },
        ...
        onResponderMove: (e) => {
          if (import_core.isWeb) {
            ...
            if (!(!state.current.isScrolling && dy > 0 && scrollBridge.y === 0) && scrollBridge.y >= 0)
              return;
