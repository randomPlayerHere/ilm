...
const SliderHorizontal = React.forwardRef(
  (props, forwardedRef) => {
    const {
      ...
      onSlideEnd,
      ...sliderProps
    } = props, direction = (0, import_use_direction.useDirection)(dir), isDirectionLTR = direction === "ltr", sliderRef = React.useRef(null), [state, setState_] = React.useState(() => ({ size: 0, offset: 0 })), setState = (0, import_core.useCreateShallowSetState)(setState_);
...
const SliderVertical = React.forwardRef(
  (props, forwardedRef) => {
    const {
      ...
      onSlideEnd,
      ...sliderProps
    } = props, [state, setState_] = React.useState(() => ({ size: 0, offset: 0 })), setState = (0, import_core.useCreateShallowSetState)(setState_), sliderRef = React.useRef(null);
    function getValueFromPointer(pointerPosition) {
      const input = [0, state.size];
  ...
  (props, forwardedRef) => {
    const { __scopeSlider, ...trackProps } = props, context = (0, import_constants2.useSliderContext)(__scopeSlider);
