...
var blue = adjustPaletteLight("blue", blueIn),
  blueDark = adjustPaletteDark("blueDark", blueDarkIn),
  green = adjustPaletteLight("green", greenIn),
  greenDark = adjustPaletteDark("greenDark", greenDarkIn),
  purple = adjustPaletteLight("purple", purpleIn),
  purpleDark = adjustPaletteDark("purpleDark", purpleDarkIn),
  red = adjustPaletteLight("red", redIn),
  redDark = adjustPaletteDark("redDark", redDarkIn),
  yellow = adjustPaletteLight("yellow", yellowIn),
  yellowDark = adjustPaletteDark("yellowDark", yellowDarkIn),
  pink = adjustPaletteLight("pink", pinkIn),
  pinkDark = adjustPaletteDark("pinkDark", pinkDarkIn),
  orange = adjustPaletteLight("orange", orangeIn),
  orangeDark = adjustPaletteDark("orangeDark", orangeDarkIn),
  teal = adjustPaletteLight("teal", tealIn),
  tealDark = adjustPaletteDark("tealDark", tealDarkIn),
  gray = adjustPaletteLight("gray", grayIn),
  grayDark = adjustPaletteDark("grayDark", grayDarkIn),
