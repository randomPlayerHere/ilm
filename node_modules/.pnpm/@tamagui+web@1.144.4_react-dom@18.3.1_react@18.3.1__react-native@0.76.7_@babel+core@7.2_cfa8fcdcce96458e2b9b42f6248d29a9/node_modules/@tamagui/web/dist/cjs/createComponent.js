...
function createComponent(staticConfig) {
  ...
  const component = import_react.default.forwardRef((propsIn, forwardedRef) => {
    ...
    const groupContextParent = import_react.default.useContext(import_GroupContext.GroupContext), animationDriver = componentContext.animationDriver, useAnimations = animationDriver?.useAnimations, componentState = (0, import_useComponentState.useComponentState)(
      props,
    ...
    const isTaggable = !Component || typeof Component == "string", tagProp = props.tag, element = import_constants.isWeb && isTaggable && tagProp || Component, BaseTextComponent = BaseText || element || "span", BaseViewComponent = BaseView || element || (hasTextAncestor ? "span" : "div");
...
` && console.error(
    ...
    if (needsReset && !hasEverReset && (stateRef.current.hasEverResetPresence = !0), (needsReset || hasEverReset) && ResetPresence && (content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ResetPresence, { disabled: !needsReset, children: content })), process.env.NODE_ENV === "development" && time && time`create-element`, "focusWithinStyle" in propsIn && (content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
      ...
      debugProp && console.info("overriddenContextProps", overriddenContextProps), content = /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Provider, { __disableMergeDefaultValues: !0, ...overriddenContextProps, children: content });
    }
