...
var import_constants = require("@tamagui/constants"), import_react = require("react"), import_config = require("../config"), import_constants2 = require("../constants/constants");
...
const getRootThemeState = () => rootThemeState, useThemeState = (props, isRoot = !1, keys) => {
  ...
  if (!parentId && !isRoot)
    throw new Error(import_constants2.MISSING_THEME_MESSAGE);
  if (disable)
