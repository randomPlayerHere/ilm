...
function createComponent(staticConfig) {
  ...
  const component = React.forwardRef((propsIn, forwardedRef) => {
    ...
    const groupContextParent = React.useContext(GroupContext), animationDriver = componentContext.animationDriver, useAnimations = animationDriver?.useAnimations, componentState = useComponentState(
      props,
