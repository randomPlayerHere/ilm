...
function mediaObjectToString(query2, key) {
  ...
  if (cache$5.has(query2)) return cache$5.get(query2);
  ...
  return cache$5.set(query2, res), res;
}
...
function getNewThemeName() {
  ...
  } else for (var max2 = parentParts.length, i1 = 0; i1 <= max2; i1++) {
...
var cache$3 = /* @__PURE__ */ new Map(), curKeys, curProps, curState, emptyObject$5 = {};
...
const normalizeColor$3 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: index
  ...
  function(param, ref) {
    ...
    return React.useEffect(function() {
      ...
      onStartShouldSetResponder: function() {
        return scrollBridge.scrollStartY = -1, state.current.isDraggingScrollArea = true, false;
      },
      onMoveShouldSetResponder: function(e2) {
        ...
        if (state.current.lastPageY === 0) return state.current.lastPageY = pageY, false;
        var dy = Math.abs(pageY - state.current.lastPageY);
        return dy > 10;
      },
      contentContainerStyle: {
        minHeight: "100%"
...
function useFocusable(param) {
  ...
  }, [registerFocusableHandler]), handleChangeText = useEvent$1(function(value2) {
